...
namespace MonitorStorage.Models
{
    ...
    public class ApplicationLogs : Base
    {
        ...
        public async Task<IList<ApplicationLogs>> DeleteApplicationLog(List<ApplicationLogs> ApplicationLogs)
        {
            return await _applicationLogsStorage.DeleteEntity(ApplicationLogs) as List<ApplicationLogs>;
        }
